...
## Artist Name Policy（必須）
- 症例ページ・Instagramいずれにおいても、担当アーティストの個人名は表示しない
- 表記はすべて「BiBiクリニック アーティスト」に統一する
- 入力Aに個人名が含まれている場合でも、生成物には反映せず flags に記録する
- 一人称（私/僕）は使用せず、組織主語で記述する
